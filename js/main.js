...
pokemons.forEach((num) => {
	var newItem = document.createElement("li")
        ...
        var typSpan = document.createElement("p")
        var heSpan = document.createElement("p")
        var weSpan = document.createElement("p")
        var canSpan = document.createElement("p")
        var eggSpan = document.createElement("p")
        var chanSpan = document.createElement("p")
        var ageSpan = document.createElement("p")
        var time = document.createElement("time")
        var mulSpan = document.createElement("p")
        var weaSpan = document.createElement("p")
        list.appendChild(newItem)
		newItem.appendChild(numSpan)
        newItem.appendChild(img)
        newItem.appendChild(nameP)
        newItem.appendChild(typSpan)
        newItem.appendChild(heSpan)
        newItem.appendChild(weSpan)
        newItem.appendChild(canSpan)
        newItem.appendChild(eggSpan)
        newItem.appendChild(chanSpan)
        newItem.appendChild(ageSpan)
        newItem.appendChild(time)
        newItem.appendChild(mulSpan)
        newItem.appendChild(weaSpan)
        numSpan.textContent = `${num.id}`
        nameP.textContent = `Name: ${num.name}`
        img.src = `${num.img}`
        img.alt = `${num.type}`
        typSpan.textContent = `Type: ${num.type}`
        heSpan.textContent = `Height: ${num.height}`
        weSpan.textContent = `Weight: ${num.weight}`
        canSpan.textContent = `Candy: ${num.candy}`
        eggSpan.textContent = `Egg: ${num.egg}`
        chanSpan.textContent = `Spawn-chance: ${num.spawn_chance}`
        ageSpan.textContent = `Age: ${num.avg_spawns}`
        time.textContent = `Spawn-time: ${num.spawn_time}`
        time.dateTime = `${num.spawn_time}`
        mulSpan.textContent = `Multipliers: ${num.multipliers}`
        weaSpan.textContent = `Weaknesses: ${num.weaknesses}`
        newItem.classList.add("item")
		typSpan.classList.add("span")
		nameP.classList.add("span","me")
		heSpan.classList.add("span","me")
		weSpan.classList.add("span")
		canSpan.classList.add("span","me")
		eggSpan.classList.add("span")
		chanSpan.classList.add("span","me")
		ageSpan.classList.add("span")
		time.classList.add("span","me")
		mulSpan.classList.add("span")
		weaSpan.classList.add("big-span")
		nameP.style.marginTop = 0
		numSpan.style.marginBottom = 0
